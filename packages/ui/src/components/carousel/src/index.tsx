...
export default defineComponent({
  ...
  props: {
    ...
    indicatorPosition: {
      ...
      default: "inside",
      validator: (val: IvyCarouselIndicatorPosition) =>
        ["inside", "outside", "none"].includes(val),
    },
    arrow: {
      type: String as PropType<IvyCarouselArrow>,
      default: "hover",
      validator: (val: IvyCarouselArrow) =>
        ["always", "hover", "never"].includes(val),
    },
    direction: {
      type: String as PropType<IvyCarouselDirection>,
      default: "horizontal",
      validator: (val: IvyCarouselDirection) =>
