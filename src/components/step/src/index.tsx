...
export default defineComponent({
    ...
    setup(props, { slots }) {
        ...
        const renderIcon = () => {
            console.log(getCurrStatus.value);
        ...
        return () => (
            <div class="ivy-step">
                <div class="ivy-step__line">
                    <div class={["ivy-step__line-status", isFinish.value ? `ivy-step__line-status-${getCurrStatus.value}` : null]}></div>
                </div>
                <div class="ivy-step__icon">
                    <div class={["ivy-step__icon-inner", `ivy-step__icon-inner-${getCurrStatus.value}`]}>{renderIcon()}</div>
                </div>
                <div class="ivy-step__main">
                    <div class={["ivy-step__main-title", `ivy-step__main-title-${getCurrStatus.value}`]}>
                        {slots.header ? slots.header?.() : props.header}
                    </div>
                    <div class="ivy-step__main-desc">{slots.default ? slots.default?.() : props.description}</div>
                </div>
            </div>
        );
    },
