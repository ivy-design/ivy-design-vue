import { computed, defineComponent, onMounted, ref, Teleport, Transition } from 'vue'
...
export default defineComponent({
  ...
  setup(props, { slots }) {
    ...
    const { visible, targetRef, triggerRef, arrowRef, initPopper, updatePopper } = usePopper(
      conf.value
    )
    ...
    return () => {
      return (
        <div class={prefixCls} onMouseenter={handleShowPopper} onMouseleave={handleClosePopper}>
