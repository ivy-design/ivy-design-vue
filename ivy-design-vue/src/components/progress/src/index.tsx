  ...
  setup(props) {
    ...
    return () => {
      return (
        ...
        >
          {props.type === 'line' ? (
            <div class={['ivy-progress-bar', { 'is-text-nside': props.textInside }]}>
              <div class="ivy-progress-bar__outer" style={{ height: `${props.strokeWidth}px` }}>
                <div
                ...
                >
                  {props.textInside && props.showText ? (
                    <span class="ivy-progress-bar__inner-text">{props.percentage}%</span>
                  ) : null}
                </div>
              </div>
            </div>
